...
LexicalAnalysis::LexicalAnalysis(string in) : input(in), charClass(ERROR_R), nextChar(' '), lexeme(""){ getChar(); } 
...
vector<string> LexicalAnalysis::loadLeximes(string fileName)
{
	vector<string> v ;
	ifstream file;
